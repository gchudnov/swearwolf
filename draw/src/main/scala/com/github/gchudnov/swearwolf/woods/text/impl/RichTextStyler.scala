...
import com.github.gchudnov.swearwolf.draw.text.impl.RichTextParser.{ Attr, Block }
import com.github.gchudnov.swearwolf.draw.util.impl.Func
import com.github.gchudnov.swearwolf.util.colors.Color
import RichTextParser.*
import com.github.gchudnov.swearwolf.draw.text.RichTextException
...
private[text] object RichTextStyler:
  ...
  private[impl] final case class RichBoxStyle(inner: Seq[RichStyle])                      extends RichStyle
  private[impl] final case class RichTextStyle (value: String)                             extends RichStyle
  private[impl] final case class RichForegroundStyle (color: Color, inner: Seq[RichStyle]) extends RichStyle
  private[impl] final case class RichBackgroundStyle (color: Color, inner: Seq[RichStyle]) extends RichStyle
  private[impl] final case class RichBoldStyle (inner: Seq[RichStyle])                     extends RichStyle
  private[impl] final case class RichItalicStyle (inner: Seq[RichStyle])                   extends RichStyle
  private[impl] final case class RichUnderlineStyle (inner: Seq[RichStyle])                extends RichStyle
  private[impl] final case class RichBlinkStyle (inner: Seq[RichStyle])                    extends RichStyle
  private[impl] final case class RichInvertStyle (inner: Seq[RichStyle])                   extends RichStyle
  private[impl] final case class RichStrikethroughStyle (inner: Seq[RichStyle])            extends RichStyle
