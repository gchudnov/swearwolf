package com.github.gchudnov.swearwolf.draw.graph.impl
...
import com.github.gchudnov.swearwolf.draw.GraphStyle.{ Dot, Quad, Step }
import com.github.gchudnov.swearwolf.draw.util.Symbols
...
private[graph] object GraphDrawer:
  ...
  def draw(screen: Screen)(pt: Point, graph: Graph, textStyle: TextStyle): Either[Throwable, Unit] =
    ...
    for _ <- Func.sequence(lines.zipWithIndex.map { case (line, i) =>
